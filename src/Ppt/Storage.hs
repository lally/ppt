module Ppt.Storage (loadConfig, binaryPath, specPath, makeSpecPath, createConfig) where
...
import qualified Ppt.StaticInstrumentation as SI
...
specPath (RunConfig cfg _) spec@(SI.Spec _ (SI.Buffer name _ _ ) _ ) =
